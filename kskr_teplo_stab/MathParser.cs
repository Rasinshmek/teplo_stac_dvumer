...
namespace kskr_teplo_stab
{
    public class MathParser
    {
        ...
        public double Parse(string expression, bool isRadians = true)// основной метод парсера в обработке исключений
        {
        ...
        private string FormatString(string expression)//Форматирование строки
        {
        ...
        private string ConvertToRPN(string expression)// Лексический анализ с обработкой исключений
        {
        ...
        private string LexicalAnalysisInfixNotation(string expression, ref int pos)//лексический анализ
        {
            // Receive first char
        ...
        private bool Priority(string token, string p)//Выставление приоритетов
        {
        ...
        private int GetPriority(string token)//Описание приоритетов
        {
            switch (token)
            {
                case LeftParent:
        ...
        private double Calculate(string expression)//Вычисление
        {
            int pos = 0; // Current position of lexical analysis
        ...
        private double ApplyTrigFunction(Func<double, double> func, double arg)//Формат ввода угла
        {
            if (!isRadians)
            {
